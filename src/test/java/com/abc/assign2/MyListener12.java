...
//"Source" -> Override Implement methods and can select the methods declared in the ITestListener interface. After that we can delete
...
public class MyListener12 implements ITestListener{
